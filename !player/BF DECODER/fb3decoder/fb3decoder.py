...
ebxFolder    = r"bundles\ebx\sound\music" #files are not restricted to the Sound folder in bf4. As a result it will seem that the script does nothing for a while.
